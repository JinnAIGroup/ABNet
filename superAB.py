'''   YJW, 2021.12.2
It will be "new" if you can use long skips from EfficientNet to UNet's decoder and show that
(1) the long skips improve semantic segmentation (SS),
(2) the combined Eff-UNet outperforms individual EfficientNet and UNet in both SS and path planning (PP).
modelABC = EffNet + UNet + RNN + PoseNet
1. Will modelABC = EffNet + UNet + RNN + PoseNet be too big for C2 to run?
2. How do we train modelABC (how many stages or how many more A and B data sets)?
'''
